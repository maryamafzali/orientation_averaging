...
load w_hans_43dir_rand_LP_03.mat
...
rng(1)
N=43;
% r  = randn(N,3);                           % 3d Gaussian
% 
% r1 = [r(:,1)./sqrt(sum(r.^2,2)), r(:,2)./sqrt(sum(r.^2,2)), r(:,3)./sqrt(sum(r.^2,2))];    % normalize radius
% 
% bvec = r1';
...
% Vwgts = Optimize_SPH_filters_new('Distr',bvec','plotlev',0,'LPwgtwid',0.25);
