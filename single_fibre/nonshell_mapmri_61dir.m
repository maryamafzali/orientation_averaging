...
load X_488_Qdistr_03752__1.00_2.00_2.00_1.00_0.00_J0_S1_4.00_1.50_0.25.mat % non_shelled
...
%                     Sn(:,i,l,n,p) = sqrt((squeeze(S(:,i,l,n)) + squeeze(noise_gen(i,1:61,1,l,n,p))').^2 + ...
%                         squeeze(noise_gen(i,1:61,2,l,n,p))'.^2);
